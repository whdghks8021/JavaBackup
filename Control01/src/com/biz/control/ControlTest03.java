...
public class ControlTest03 {
	...
	public static void main(String[] args) {
		...
		// intMode는 0 아니면 1인 값을 당연이 가지고있다.
		// 라고 생각하지만, 어떤 불가항력적인 이유로 0과 1이 아닌 값을 가질수 있다.
		// 그래서 기준이 되는 intMode == 0 이라는 식의 반대되는 개념은
		// intMode == 1 이 아닌 intMode != 0 이라는 생각을 해야한다.
		if(intMode == 1) {}  // 잘못됨(오류가능성)
		if(intMode != 0) {   // 올바른것
		}
