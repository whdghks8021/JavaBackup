...
public class ScoreService {
	...
	/*
	 * 입력을 선택하면 1. 학번을 입력받도록 하고 2. 학번에 대한 학생정보를 보여주고 3. 이미 점수가 입력 되어 있으면 점수를 보여주고 4.
	 * 점수를 입력하지 않고 Enter를 누르면 기존 점수를 유지하고 >> 수정 상태로 변경 5. 점수가 없는 경우에는 6. 새로운 점수를
	 * 입력받고 7. 점수를 insert 한다.
	 */
